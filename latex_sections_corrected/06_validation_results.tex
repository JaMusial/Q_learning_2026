...
The choice $T_e = 10$~s represents a moderate 2$\times$ speed-up compared to the baseline $T_I = 20$~s. This ratio provides sufficient performance improvement potential while maintaining manageable projection function magnitudes.
...
\item \textbf{Projection Function:} Should enable bumpless switching despite $T_e = 10$~s vs. $T_I = 20$~s mismatch
\end{enumerate}
